...
* A skeleton is a very basic summary of the details of the story with characters, storyline beats, and other assorted information. The skeleton is written to Skeleton
* An outline is a much more fleshed-out overview of the story with more focus on world-building and building layers. The outline is written to Outline
...
* The skeleton should always be written in Markdown and saved in a file called "Skeleton".
...
* The outline should always be written in Markdown and saved in a file called "Outline".
